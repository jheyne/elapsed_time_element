...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static daysVerbose(days) => "${Intl.plural(days, zero: '', one: '${days} día', other: '${days} días')}";
  ...
  static secondsVerbose(seconds) => "${Intl.plural(seconds, zero: '', one: '${seconds} segundo', other: '${seconds} segundos')}";
